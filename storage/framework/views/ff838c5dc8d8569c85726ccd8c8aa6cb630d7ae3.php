        ...
        <div class="container">
            <div class="row align-items-stretch min-height-50">
                ...
                <div class="col align-self-center">
                    <!-- Search-Form -->
                    <form class="js-focus-state" method="GET" action="<?php echo e(route('home')); ?>">
                ...
                <div class="col-md-auto align-self-center">
                    <div class="d-flex">
                        <ul class="d-flex list-unstyled mb-0">
                            <li class="col pr-0">
                                <a href="<?php echo e(route('cart')); ?>" class="text-gray-90 position-relative d-flex "
                                    ...
                                    <?php if(auth()->guard()->check()): ?>
                                        ...
                                        <span class="font-weight-bold font-size-16 text-gray-90 ml-3">Rp
                                            <?php echo e(number_format($price_total, 2, ',', '.')); ?></span>
                                    <?php endif; ?>
                                </a>
                            </li>
                        </ul>
...
<?php /**PATH D:\UNUD\Semester 4\Praktikum Pemrograman Internet\praktikum-prognet\resources\views/livewire/cart.blade.php ENDPATH**/ ?>