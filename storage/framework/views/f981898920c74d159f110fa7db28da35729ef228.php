                    ...
                    <div class="col-auto">
                        ...
                        <nav
                            ...
                            <a class="order-1 order-xl-0 navbar-brand u-header__navbar-brand u-header__navbar-brand-center"
                                href="<?php echo e(route('home')); ?>" aria-label="Electro">
...
} elseif ($_instance->childHasBeenRendered('58lOiHh')) {
    $componentId = $_instance->getRenderedChildComponentId('58lOiHh');
    $componentTag = $_instance->getRenderedChildComponentTagName('58lOiHh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('58lOiHh');
} else {
    $response = \Livewire\Livewire::mount('cart-livewire');
    $html = $response->html();
    $_instance->logRenderedChild('58lOiHh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<!-- ========== END HEADER ========== -->
<?php /**PATH D:\Kuliah\SEMESTER IV\Praktikum Prognet\praktikum-prognet\resources\views/layouts/user-layout/partials/header.blade.php ENDPATH**/ ?>