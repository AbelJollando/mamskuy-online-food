    ...
    <div class="mb-2">
        <div class="card p-5 border-width-2 border-color-1 borders-radius-17">
            <div class="text-gray-9 font-size-14 pb-2 border-color-1 border-bottom mb-3">Availability:
                <span class="text-green font-weight-bold"><?php echo e($product->stock); ?> in stock</span>
            </div>
            <div class="mb-3">
                ...
                <?php else: ?>
                    <div class="font-size-36">Rp <?php echo e(number_format($product->price, 2, ',', '.')); ?>
            ...
            <div class="mb-3">
                <a href="<?php echo e(route('product.buynow', [$product, 'qty' => $qty])); ?>" class="btn btn-block btn-dark">Buy
                    Now</a>
            </div>
        </div>
    </div>
</div>
<?php /**PATH D:\UNUD\Semester 4\Praktikum Pemrograman Internet\praktikum-prognet\resources\views/livewire/product-mini-cart.blade.php ENDPATH**/ ?>